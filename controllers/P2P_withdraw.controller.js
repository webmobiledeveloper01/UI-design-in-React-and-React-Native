...
module.exports = {
    async P2P_withdrawal (req, res, next) {
                        ...
                        if (find_user.kycVerified =="v") {
                            if (!find_user.first_deposit) { 
                                ...
                                if(wallet_amount >= req.body.withdrawal_amount){
                                    // const find_payout_tax = await P2P_withdrawModel.find({UserId:req.body.UserId,createdAt:{ $lte: today_date},status:"Success"}).sort({_id:-1})
                                    ...
                                    //     const one = (parseFloat(req.body.withdrawal_amount)*1)/100
                                    //     const finAmt = parseFloat(req.body.withdrawal_amount) - parseFloat(one)
                                    //     const find_payout = await P2P_withdrawModel.find({UserId:req.body.UserId,createdAt:{ $gte: Date_date},status:"Success"}).sort({_id:-1})
                                    //     if(find_payout.length<1){
                                            if(req.body.withdrawal_amount >= 500){ // 1
                                                if(req.body.withdrawal_amount <= 3000){ 
                                    //                 const one = parseFloat((req.body.withdrawal_amount)*1/100);
                                    //                 const finAmt = parseFloat(req.body.withdrawal_amount) - parseFloat(one);
                                                    const amt = parseFloat(req.body.withdrawal_amount) - parseFloat((req.body.withdrawal_amount)*0.10)
                                                    const schema = new P2P_withdrawModel()
                                                    ...
                                                    schema.usdt = req.body.usdt
                                                    schema.withdrawal_amount = amt
                                                    ...
                                                    schema.reason = req.body.reason
                                                    schema.coin = req.body.coin

                                                    if(req.body.wallet_type == 'interest_wallet'){
                                                        schema.liquidity_interest = interest_amt
                                                        schema.stake_interest = staking_amt
                                                    }
                                                    P2P_withdrawModel.create(schema).then(createPayout=>{
                                                        ...
                                                        if(req.body.wallet_type == 'netstaking_wallet'){
                                                            ...
                                                            schema_create.P2P_withdrawal_id = createPayout._id
                                                        ...
                                                        if(req.body.wallet_type == 'interest_wallet'){
                                                            ...
                                                            schema_create1.P2P_withdrawal_id = createPayout._id
                                                        ...
                                                        schema_create2.P2P_withdrawal_id = createPayout._id
                                    ...
                                    //                         schema.utr_id = req.body.utr_id
                                    //                         schema.reason = req.body.reason
                                    //                         schema.stake_interest = req.body.stake_interest
                                    //                         schema.liquidity_interest = req.body.liquidity_interest
                                    //                         schema.coin = req.body.coin
                                    ...
                                    //     }
                                    // } else{
                                    //     const find_payout = await P2P_withdrawModel
